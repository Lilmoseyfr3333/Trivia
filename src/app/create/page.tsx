...
export default function CreatePage() {
  ...
  function bulkAddFromText(raw: string) {
    // Supports:
    // - each line: "prompt | answer | alias1; alias2"
    // - or just "answer" per line
    ...
    <AppShell
      right={
        <div className="hidden sm:flex items-center gap-2">
          ...
          <Pill tone={validation.ok ? "green" : "red"}>
            {validation.ok ? "Ready to save" : "Needs work"}
          </Pill>
        </div>
      }
    >
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2">
              ...
              <Pill tone="neutral">Sporcle-style typing</Pill>
            </div>

            <h1 className="mt-4 text-2xl sm:text-3xl font-black tracking-tight">
              Build a quiz people can finish… or rage-quit with dignity.
            </h1>
            <p className="mt-2 text-sm muted max-w-2xl">
              Keep it simple: clean title, clear category, and a tight answer list.
              Prompts are optional but make the quiz feel “official”.
            </p>
          </div>
      ...
      <div className="mt-5 grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2">
          {step === "Basics" ? (
            <div className="card-strong p-6">
              ...
              <div className="text-sm muted mt-1">This is the cover of the book. Make it good.</div>
              ...
              <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="sm:col-span-2">
                  ...
                  <div className="text-xs muted mt-1">
                    Minimum 3 characters. (Yes, this stops “aaa”. You’re welcome.)
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    min={30}
                  />
                  <div className="text-xs muted mt-1">Typical: 180–420 seconds.</div>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Tell players what this quiz is (1–2 sentences)."
                  />
                </div>
          ...
          {step === "Answers" ? (
            <div className="card-strong p-6">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <div className="text-sm muted mt-1">
                    Prompts are optional. Aliases help accept “Steph” vs “Stephen”.
                  </div>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="mt-5 card p-4">
                ...
                <div className="mt-3">
                  <Textarea ref={bulkRef as any} placeholder={"2016 MVP | Stephen Curry | Steph Curry; Curry\nLos Angeles | Lakers | LA Lakers"} />
                </div>
                ...
                <div className="mt-3 flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between">
                  ...
                  <div className="text-xs muted">
                    Current valid answers: <span className="font-bold text-[#0F172A]">{validation.itemsCount}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-5 overflow-hidden border strong-border rounded-[22px]">
                <div className="grid grid-cols-12 bg-[rgba(15,23,42,0.02)] border-b strong-border px-4 py-2 text-xs font-bold muted">
                  <div className="col-span-4">Prompt (optional)</div>
          ...
          {step === "Preview" ? (
            <div className="card-strong p-6">
              ...
              <div className="mt-5 card p-5">
                ...
                <div className="mt-4 text-sm font-extrabold">Sample answer grid</div>
        ...
        <div className="lg:col-span-1">
          <div className="card p-5">
            ...
            <div className="text-xs muted mt-1">If these are green, you’re good.</div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm font-semibold">Total answers</div>
          ...
          <div className="mt-4 card p-5">
            <div className="text-sm font-extrabold">Fast formats</div>
            <div className="text-xs muted mt-1">Copy/paste ready.</div>

            <div className="mt-3 text-xs font-semibold muted">
              Prompt | Answer | alias1; alias2
            </div>
            <div className="mt-2 text-xs muted">
              2011 MVP | Derrick Rose | D Rose
              <br />
              Team nickname | Mavericks | Mavs
            </div>
          </div>
        </div>
      </div>
